...
//=========================================================================================
//-------000webhost-------
    static String connect_ip = "http://tcnr1608.000webhostapp.com/android_mysql_connect/";//000webhost
    //-------000webhost--組長-----
...
//    static int code;
//    static String mysql_code = null;
//    static String connect_ip = "https://tcnr1601.000webhostapp.com/android_mysql_connect/";//Hostinger
//
//    //------select MySQL--------------------------------------------------
//
//
...
////-------Hostinger-------
//            HttpPost httpPost = new HttpPost(connect_ip+"android_connect_db_all.php");  //指定php檔案
//            //+s json協定
////-------000webhost--組長-----
...
//            params.add(new BasicNameValuePair("selefunc_string", "query"));
//            // query_string -> 給php 使用的參數
//            httpPost.setEntity(new UrlEncodedFormEntity(params, HTTP.UTF_8));  //params是php?id=1的變數
//            HttpResponse httpResponse = httpClient.execute(httpPost);
//
//            // -----------------------------------------------------------------
//            // 使用httpResponse的方法取得http 狀態碼設定給httpstate變數
...
//    }
//
//    public static String executeDelete(String delete_from_member_, ArrayList<NameValuePair> nameValuePairs)
//    {
//        is = null;
//        result = null;
//        line = null;
...
//        // ------------------------------
//        ArrayList<NameValuePair> params = new ArrayList<NameValuePair>();
//        params.add(new BasicNameValuePair("selefunc_string", "update"));
//
//        try {
//            httpPost.setEntity(new UrlEncodedFormEntity(nameValuePairs,
//                    HTTP.UTF_8));
