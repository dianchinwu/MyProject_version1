...
import tw.tcnr08.a0001.providers.FriendsContentProvider;
...
//import java.util.Map;
//
//import tw.tcnr08.m1417.providers.FriendsContentProvider;
//
//
//public class Main extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
//    String TAG = "tcnr08=>";
...
//    private Menu menu;
//    private boolean flag,touch_flag; //關閉ontuchevent
//    //-----------------------------------------
...
//    // ------------------
//    SimpleDateFormat formatter = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");  //java class
//    private TextView nowtime;  //顯示更新時間及次數
//    int old_index = 0;
//    int update_time = 0;
//    String showip;   //顯示手機ip
...
////        bsubTitle = (TextView) findViewById(R.id.subTitle);
////
////        blinear01 = (LinearLayout) findViewById(R.id.linear01);
////        blinear02 = (LinearLayout) findViewById(R.id.linear02);
////        b_Relbutton = (RelativeLayout) findViewById(R.id.Relbutton);
////        bsubTitle = (TextView) findViewById(R.id.subTitle);
////        b_editon = (TextView) findViewById(R.id.edit_on);
...
//        //-----------------
//        mSpnName = (Spinner) this.findViewById(R.id.spnName);
//        mSpnName.setOnItemSelectedListener(this);  //mSpnNameOnItemSelLis
//
//        nowtime = (TextView) findViewById(R.id.now_time);
//        nowtime.setTextSize(12);  //更新時間字型
//        // -------------------------
...
//        e001.setText(fld[1]);  //name
//        e002.setText(fld[2]);  //grp
//        e003.setText(fld[3]);  //addr
//    }
//
//
//    @Override
...
//                    setupViewComponent();
////                    showRec(index);
//                    u_spinmove(old_index-1);  //刪除後退回前一筆資料,若全空無資料時填0
//                }
//
//                Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_SHORT).show();
//                break;
...
//        ArrayList<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
//        nameValuePairs.add(new BasicNameValuePair("id", s_id));
//        String result = DBConnector.executeDelete("DELETE From member ", nameValuePairs);
//        Log.d(TAG,s_id);
//        dbmysql();
//    }
//
...
//    }
//
//    private void mysql_insert()  //將資料新增進遠端資料庫MySQL
//    {
////        ArrayList<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();  //key,value做bundle陣列傳值
//        ArrayList<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
//
//        nameValuePairs.add(new BasicNameValuePair("name", tname));  //key,value做bundle陣列傳值,接收edittext的值
//        nameValuePairs.add(new BasicNameValuePair("grp", tgrp));  //key,value做bundle陣列傳值
//        nameValuePairs.add(new BasicNameValuePair("address", taddr));  //key,value做bundle陣列傳值
//
//        //-----------------------------------------------
//        try{
//            Thread.sleep(500);  //睡0.5秒,延遲新增
//        }catch (InterruptedException e){
//            e.printStackTrace();
//        }
//        //-----------------------------------------------
//        String result = DBConnector.executeInsert("SELECT * FROM member", nameValuePairs);  //新增DBConnector方法,將資料傳到MySQL
//
//    }
//
//    private ArrayList<String> u_selectdb(String myselection, String[] myargs, String myorder) {
...
////            e003.setText(fld[3]);
//////            mSpnName.setSelection(index, true); //spinner 小窗跳到第幾筆
////            u_spinmove(index);  //接收方法的name是什麼就寫什麼 private void showRec(int index) {...}
////
////        } else {
////            String stHead = "顯示資料：0 筆";
////            msg = getString(R.string.count_t) + "0筆";
...
////    private void dbmysql()
////    {
////        mContRes = getContentResolver();  //管理SQLite
////        Cursor cur = mContRes.query(FriendsContentProvider.CONTENT_URI,MYCOLUMN,null,null,null);
////        cur.moveToFirst();
////        try{
////            String result = DBConnector.executeQuery("SELECT * FROM member");
...
////            if(jsonArray.length() > 0){  //MySQL 連結成功有資料
////                Uri uri = FriendsContentProvider.CONTENT_URI;
////                mContRes.delete(uri, null, null); // 刪除SQLite所有資料 delete是系統函數(空class)
////                // ----------------------------
////                // 處理JASON 傳回來的每筆資料
////                for(int i=0 ; i<jsonArray.length() ; i++){
////                    JSONObject jsonData = jsonArray.getJSONObject(i);  //每一筆回傳的資料都是JSONObject
////                    ContentValues newRow = new ContentValues();
////                    // --(1) 自動取的欄位
////                    // --取出 jsonObject
////                    // 每個欄位("key","value")-----------------------
...
////                    // .toString());
////                    //-------------------加入SQLite---------------------------------------
////                    mContRes.insert(FriendsContentProvider.CONTENT_URI, newRow);  //mContRes指SQLite
////                    tvTitle.setTextColor(Color.BLUE);
////                    tvTitle.setText("顯示資料： 共加入" + Integer.toString(jsonArray.length()) + " 筆");
////                }//end for
////
...
//        try {
//            String result = null;
//            result = DBConnector.executeQuery("SELECT * FROM member");
//
...
//                        Toast.LENGTH_LONG).show();
//            } else {
//                int checkcode=DBConnector.httpstate/100;  //除以100取整數
//                switch(checkcode){
//                    case 1:
//                    msg="資訊回應(code:"+DBConnector.httpstate+")";
//                    break;
...
//                    break;
//                    case 5:
//                    msg="伺服器errorresponses，請稍後再試(code:"+DBConnector.httpstate+")";
//                    break;
//                }
//                Toast.makeText(getBaseContext(),msg,Toast.LENGTH_LONG).show();
//            }
...
//    }
//
//    private void u_button_ontouch()  //編輯中將上下一筆等按鈕關閉
//    {
//        btTop.setVisibility(View.VISIBLE);
//        btNext.setVisibility(View.VISIBLE);
//        btPrev.setVisibility(View.VISIBLE);
...
//                e002.setText("");
//                e003.setText("");
//                e001.setHint(getString(R.string.hint));
//                u_menu_return();
//                break;
//
//            case R.id.m_mysql: // 匯入MySQL
...
//////                break;
//////
//////            case R.id.m_mysql:  //匯入mysql,之後要隔兩分鐘自動匯入
//////                dbmysql();
//////                break;
//////
//////            case R.id.action_settings:
